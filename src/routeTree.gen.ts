...
const DashboardLayoutAdminRoute = DashboardLayoutAdminRouteImport.update({
  id: '/admin',
  path: '/admin',
  getParentRoute: () => DashboardLayoutRoute,
} as any)
...
const DashboardLayoutuserViewfrontOfficeMonitoringIndexRoute =
  DashboardLayoutuserViewfrontOfficeMonitoringIndexRouteImport.update({
    id: '/(user-view)/(front-office)/monitoring/',
    path: '/monitoring/',
    getParentRoute: () => DashboardLayoutRoute,
  } as any)
...
export interface FileRoutesByFullPath {
  ...
  '/admin': typeof DashboardLayoutAdminRouteWithChildren
...
export interface FileRoutesById {
  ...
  '/_dashboard-layout/admin': typeof DashboardLayoutAdminRouteWithChildren

...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        'flex size-full items-center justify-center rounded-full bg-muted text-xs text-muted-foreground group-data-[size=sm]/avatar:text-[11px] group-data-[size=xl]/avatar:text-[20px]',
        className
      )}
      {...props}
    />

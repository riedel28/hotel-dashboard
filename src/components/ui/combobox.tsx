...
function ComboboxInput({
      ...
      >
        ...
        <ComboboxPrimitive.Input
          render={
            <InputGroupInput
              disabled={disabled}
              className="placeholder:text-muted-foreground h-11 py-3 text-sm outline-none focus:outline-none focus-visible:outline-none"
            />
          }
          {...props}
        />
  ...
  return (
    <InputGroup className={cn('w-auto', className)}>
      {iconLeft ? <InputGroupAddon>{iconLeft}</InputGroupAddon> : null}
      <ComboboxPrimitive.Input
...
function ComboboxList({ className, ...props }: ComboboxPrimitive.List.Props) {
  return (
    <ComboboxPrimitive.List
      ...
      className={cn(
        'no-scrollbar max-h-[min(calc(--spacing(86)---spacing(9)),calc(var(--available-height)---spacing(9)))] scroll-py-1 overflow-y-auto p-1 data-empty:p-0 overscroll-contain',
        className
      )}
      {...props}
    />
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        'dark:bg-input/30 border-input focus-within:border-ring focus-within:ring-ring/50 has-aria-invalid:border-destructive has-aria-invalid:shadow-[inset_0_0_0_1px_var(--color-destructive)] has-aria-invalid:focus-within:border-destructive has-aria-invalid:focus-within:ring-destructive/50 flex min-h-9 flex-wrap items-center gap-1.5 rounded-md border bg-transparent bg-clip-padding px-2.5 py-1.5 text-sm shadow-xs transition-[color,box-shadow] focus-within:ring-[3px] has-data-[slot=combobox-chip]:px-1.5',
        className
      )}
      {...props}
    />
